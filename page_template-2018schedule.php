<?php
/**
 * Template Name: Queens2018 Schedule
 *
 *
 * @package oewebsite
 */
...
<div class="three-fourths">
    <div class="schedule-2016">
        ...
        $conferenceDays = array(
            ...
            'Friday' => array('Featured', 'Open Houses', 'After Hours'),
            'Saturday' => array('Featured', 'All Day', 'Morning', 'Lunchtime', 'Open Platform', 'Afternoon', 'Evening', 'After Hours'),
            'Sunday' => array('Featured', 'All Day', 'Morning', 'Lunchtime','Open Platform', 'Afternoon', 'Evening', 'After Hours'),
        )
        ?>
                        ...
                        <div class="expander">
                            <?php foreach($conferenceDays[$confDay] as $group): ?>
                                ...
                                <div id="js-expander-content" class="expander-content">
                                    ...
                                    //                                    }
                                    //                                    ?>
                                    <?php include( locate_template( 'taxonomy-cr3ativconfcategory-include2018.php' ) ); ?>
                                </div>
                            <?php endforeach; ?>
                        </div>
